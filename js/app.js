(function () {
  ...
  const translations = {
    ...
    ay: {
      ...
      subtitle: "Local ist'awi acústico",
      clearAll: "Taqi chhaqtaya",
      removeAudio: "Apaqa",
      playAudio: "Audio ist'aña",
      localEngine: "Motor ONNX",
      loadModel: ".onnx apxataña",
      noCloud: "Audio janiw nube ukar apayaskiti.",
      uploadAudio: "Audio apxataña",
      dragDrop: "Aka chiqaru qatati jan ukax klik luram",
      formats: "WAV, MP3, M4A, OGG, FLAC jan ukax AAC",
      chooseFiles: "Archivonaka ajlliña",
      chooseFolder: "Carpeta ajlliña",
      ctrlClick: "Walja ajlliñatakix Ctrl + Clic apnaqam",
      thresholdTitle: "Inferencia wakichawi",
      ...
      results: "Inferencia mistuwi",
      eventsFound: "{n} ist'awi eventos jikxatasi.",
      stopAudio: "Audio sayt'ayaña",
      playMinute: "Minuto ist'aña",
      playSelected: "Ajllita ist'aña",
      downloadCsv: "CSV apaqaña",
      file: "Archivo",
      start: "Qallta (s)",
      end: "Tukuy (s)",
      duration: "Pacha",
      label: "Etiqueta",
      action: "Lurawi",
      privacyTitle: "100% local lurawi",
      privacyDesc: "Audio ukat IA modelo navegador manqhan ONNX Runtime Web ukamp lurasi. Janiw archivo servidor ukar apayaskiti.",
      close: "Jist'antaña",
      btnEditOn: "Edición interactiva naktayaña",
      btnEditOff: "Edición jist'antaña",
      editBannerInfo: "Segmento ukar klik luram ajlliñataki. Doble klik ajlliwi chhaqtayañataki. Etiqueta:",
      createHint: "Espectrograma jan ukax amplitud patxar qatati, machaq Telmatobius segmento lurañataki.",
      editBannerNone: "Janiw ajllitakiti",
      editBannerSelected: "Ajllita",
      labelTelma: "Telmatobius",
      delete: "Chhaqtayaña",
      welcomeTitle: "TelmatoFinder ukar jutäwi",
      welcomeP1: "Aka app webjam uñsti, ukampis modelo acústico navegador manqhan ONNX Runtime Web ukamp saraski.",
      welcomeP2: "Audio apxatkasax navegadoramaw inferencia local luraski. Janiw archivo jan ukax dato servidor ukar apayaskiti.",
      projectVideo: "Proyecto juk'amp yatiñatakix aka video uñtam.",
      btnAccept: "Iyawsaña ukat sarantaña",
      btnDecline: "Janiw saña",
      declineMsg: "Aka herramienta apnaqañatakix local lurawi términos iyawsañamawa.",
      landscapeTitle: "Pozuelos quta cuenca, Jujuy",
      loadExamples: "Ejemplonaka apxataña",
      examplesTitle: "Ejemplonaka",
      examplesDesc: "Phisqa audio testing_location ukat, out-of-sample contexto.",
      modelAuto: "Modelo automático",
    ...
    qu: {
      ...
      subtitle: "Local uyariy acústico",
      clearAll: "Tukuyta pichay",
      removeAudio: "Qichuy",
      playAudio: "Audiota uyariy",
      localEngine: "Motor ONNX",
      loadModel: ".onnx churay",
      noCloud: "Audiokuna mana nube-man apachikunchu.",
      uploadAudio: "Audio churay",
      dragDrop: "Kayman aysay utaq klik ruray",
      formats: "WAV, MP3, M4A, OGG, FLAC utaq AAC",
      chooseFiles: "Archivokunata akllay",
      chooseFolder: "Carpetata akllay",
      ctrlClick: "Achka akllanapaq Ctrl + Clic hap'iy",
      thresholdTitle: "Inferencia wakichiy",
      threshold: "Detección umbral",
      ...
      results: "Inferencia lluqsisqan",
      eventsFound: "{n} uyariy eventos tarisqa.",
      stopAudio: "Audiota sayachiy",
      playMinute: "Minutota uyariy",
      playSelected: "Akllasqata uyariy",
      downloadCsv: "CSV uraykachiy",
      file: "Archivo",
      start: "Qallariy (s)",
      end: "Tukuy (s)",
      duration: "Pacha",
      label: "Etiqueta",
      action: "Ruray",
      privacyTitle: "100% local ruray",
      privacyDesc: "Audiokuna chaymanta IA modelokuna navegador ukhupi ONNX Runtime Webwan ruran. Mana archivo servidor-man apachikunchu.",
      close: "Wichq'ay",
      btnEditOn: "Edición interactiva kichay",
      btnEditOff: "Edición wichq'ay",
      editBannerInfo: "Segmentopi klik ruray akllanapaq. Iskay klik mana akllasqa kanapaq. Etiqueta:",
      createHint: "Espectrograma utaq amplitud patapi aysay, musuq Telmatobius segmento ruranapaq.",
      editBannerNone: "Mana akllasqa",
      editBannerSelected: "Akllasqa",
      labelTelma: "Telmatobius",
      delete: "Pichay",
      welcomeTitle: "TelmatoFinder-man allin hamuy",
      welcomeP1: "Kay app web hina kachkan, ichaqa modelo acústico navegador ukhupi ONNX Runtime Webwan purin.",
      welcomeP2: "Audiokunata churaptiki, navegadorniyki inferencia localta ruran. Mana archivo utaq dato servidor-man apachikunchu.",
      projectVideo: "Proyecto aswan yachanaykipaq kay videota qhaway.",
      btnAccept: "Ari nispa ñawpaqman riy",
      btnDecline: "Mana",
      declineMsg: "Kay herramienta apaykachanapaq local ruray términos ari ninayki tiyan.",
      landscapeTitle: "Pozuelos qucha cuenca, Jujuy",
      loadExamples: "Ejemplokunata churay",
      examplesTitle: "Ejemplokuna",
      examplesDesc: "Phisqa real audio testing_locationmanta, out-of-sample contexto.",
      modelAuto: "Modelo automático",
      modelReady: "modelo listo",
  ...
  function updateTranslationNotice(dict) {
    ...
    const message = ["pt", "gn", "ay", "qu"].includes(state.lang)
